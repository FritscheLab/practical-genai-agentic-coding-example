...
```text
Implement the plan we just reviewed. Fix make_summary_figure() in
plotting/plot_summary.py to follow docs/reference/figure-specifications.md.
...
Run the Python behavior tests and figure checker. Summarize changed files,
