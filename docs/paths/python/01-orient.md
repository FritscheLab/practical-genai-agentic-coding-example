...
Open the repository in your [coding client](https://fritschelab.org/practical-genai-agentic-coding-guide/docs/platforms/index.html). Keep the baseline PNG open; attach it if your client accepts images.
